...
const uzLatin = {
  ...
  investors: {
    eyebrow: "Investorlar",
    title: "Uzoq muddatli va etik kapital bilan gaplashuvchi sahifa.",
    description:
  ...
  contact: {
    eyebrow: "Aloqa",
    title: "Birinchi taassurot brend darajasini ko‘rsatishi kerak.",
    description: "Aloqa sahifasi premium, sokin va konversiyaga tayyor bo‘lishi kerak.",
    name: "Ismingiz",
    email: "Email manzil",
    phone: "Telefon raqam",
    company: "Kompaniya yoki tashkilot",
...
const en = {
  ...
  contact: {
    eyebrow: "Contact",
    title: "Let the first impression reflect the standard of the brand.",
    description: "The contact page should feel premium, calm, and conversion-ready.",
    name: "Your name",
    email: "Email address",
    phone: "Phone number",
    company: "Company or organization",
...
const ru = {
  ...
  contact: {
    eyebrow: "Контакты",
    title: "Пусть первое впечатление сразу отражает уровень бренда.",
    description: "Контактная страница должна быть премиальной, спокойной и готовой к конверсии.",
    name: "Ваше имя",
    email: "Email",
    phone: "Телефон",
    company: "Компания или организация",
...
const ar = {
  ...
  contact: {
    eyebrow: "اتصل بنا",
    title: "ليعكس الانطباع الأول مستوى العلامة فوراً.",
    description: "يجب أن تكون صفحة التواصل راقية وهادئة ومهيأة للتحويل.",
    name: "اسمك",
    email: "البريد الإلكتروني",
    phone: "رقم الهاتف",
    company: "الشركة أو المؤسسة",
...
const dictionary: Record<LanguageCode, any> = {
  en: {
    ...en,
    network: {
      eyebrow: "Scholarly & Advisory Network",
      title: "Selected collaborating experts who strengthen MIZANIA’s knowledge and advisory depth.",
      description: "MIZANIA engages with selected scholars, researchers, and industry experts across ethical finance, Islamic finance, education, and advisory initiatives.",
      note: "Profiles are presented for general informational purposes in relation to ongoing knowledge and advisory collaboration.",
      cta: "Contact MIZANIA",
    },
  },
  ru: {
    ...ru,
    network: {
      eyebrow: "Сеть экспертов и advisory collaboration",
      title: "Избранные collaborating experts, усиливающие экспертную и консультативную глубину MIZANIA.",
      description: "MIZANIA взаимодействует с выбранными учёными, исследователями и отраслевыми специалистами в области ethical finance, Islamic finance, education и advisory initiatives.",
      note: "Профили размещены исключительно в информационных целях в рамках ongoing knowledge and advisory collaboration.",
  ...
  kir: {
    ...
    network: {
      ...
      note: "Профиллар ongoing knowledge and advisory collaboration доирасида умумий маълумот сифатида тақдим этилган.",
  ...
  lat: {
    ...
    network: {
      ...
      note: "Profillar ongoing knowledge and advisory collaboration doirasida umumiy ma’lumot sifatida taqdim etilgan.",
